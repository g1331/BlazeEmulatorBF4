...
def Login(self,data_e):
	...
	# defaulr - bf4.server.pc@ea.com
	
	mail = "bf4.server.pc@ea.com"
	password = "c0mpaq10"
	
	loginStatus = srvLogin(mail, password)
	if (loginStatus == True):
...
def srvLogin(mail, password):
	...
	if not cursor.rowcount:
		...
		print('[SQLite] Server Logging in, username and password found...')
		return True
